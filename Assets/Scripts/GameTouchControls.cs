...
//     version 1.13.1
//     from Assets/Scripts/GameTouchControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/GameTouchControls.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @GameTouchControls: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""name"": ""GameTouchControls"",
    ""maps"": [
        {
            ""name"": ""Touch"",
            ""id"": ""d6864cad-db26-4867-8813-36486417c3ae"",
            ""actions"": [
                {
                    ""name"": ""TouchPress"",
                    ""type"": ""Button"",
                    ""id"": ""c22910f8-536c-40d4-9c97-039feca767f9"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""TouchPosition"",
                    ""type"": ""Value"",
                    ""id"": ""f8cba6a7-b602-4a70-81e8-0b33ed5f5628"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""95516cce-e52b-4992-ac3d-729066dda2ba"",
                    ""path"": ""<Touchscreen>/Press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Mobile Control"",
                    ""action"": ""TouchPress"",
                    ""isComposite"": false,
                ...
                {
                    ""name"": """",
                    ""id"": ""9514cadc-3172-44be-8634-88391b629864"",
    ...
    ~@GameTouchControls()
    {
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, GameTouchControls.Touch.Disable() has not been called.");
    }
    ...
    {
        private @GameTouchControls m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TouchActions(@GameTouchControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public InputControlScheme MobileControlScheme
    {
        get
        {
            if (m_MobileControlSchemeIndex == -1) m_MobileControlSchemeIndex = asset.FindControlSchemeIndex("Mobile Control");
